import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-ZKWBNMNV.js";
import "./chunk-RUJ4DGXX.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-7TMVEJT3.js")),
  document: (0, import_react.lazy)(() => import("./pane-CHUMBTE6.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-CHUMBTE6.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-ERHQLKOR.js"))
};
...
//# sourceMappingURL=index3-4WWEUMYO.js.map
