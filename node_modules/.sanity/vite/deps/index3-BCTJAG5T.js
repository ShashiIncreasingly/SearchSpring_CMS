import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-5YQX2RXX.js";
import "./chunk-SWAIVJPB.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-MM5NAIF7.js")),
  document: (0, import_react.lazy)(() => import("./pane-GEJNRRFM.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-GEJNRRFM.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-6YDHORM7.js"))
};
...
//# sourceMappingURL=index3-BCTJAG5T.js.map
