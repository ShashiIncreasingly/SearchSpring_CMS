...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-TZLINIKO.js").then(function(n) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-N7NE4VPU.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events() {
    ...
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-N7NE4VPU.js")).default : EventSource;
        if (unsubscribed)
          return;
...
get-it/dist/middleware.browser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KPH3WNQA.js.map
