...
function getDocumentHtml(studioRootPath, props, importMap) {
  ...
  return debug$2("Rendering document component using React"), `<!DOCTYPE html>${addImportMapToHtml(
    server.renderToStaticMarkup(React.createElement(Document, { ...defaultProps, ...props, css })),
    importMap
  )}`;
}
function addImportMapToHtml(html, importMap) {
